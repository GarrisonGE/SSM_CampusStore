$(function() {
    ...
    var pageSize = 3;
    // 获取店铺列表的URL
    var listUrl = '/SSM_CampusStore/frontend/listshops';
    // 获取店铺类别列表以及区域列表的URL
    var searchDivUrl = '/SSM_CampusStore/frontend/listshopspageinfo';
    // 页码
    var pageNum = 1;
    ...
    $('.shop-list').on('click', '.card', function(e) {
        ...
        window.location.href = '/SSM_CampusStore/frontend/shopdetail?shopId=' + shopId;
    });
