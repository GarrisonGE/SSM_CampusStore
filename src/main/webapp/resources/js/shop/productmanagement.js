$(function() {
    // 获取此店铺下的商品列表的URL
    var listUrl = '/SSM_CampusStore/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
    // 商品下架URL
    var statusUrl = '/SSM_CampusStore/shopadmin/modifyproduct';
    getList();
    /**
     * 获取此店铺下的商品列表
     *
        ...
        .on(
            ...
            function(e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/SSM_CampusStore/shopadmin/productoperation?productId='
                    ...
                    window.location.href = '/SSM_CampusStore/frontend/productdetail?productId='
                        + e.currentTarget.dataset.id;
                }
            });
